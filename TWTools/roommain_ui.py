...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 11, 344, 395))
        ...
        self.ResLinkRefBtn = QtWidgets.QPushButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ResLinkRefBtn.sizePolicy().hasHeightForWidth())
        self.ResLinkRefBtn.setSizePolicy(sizePolicy)
        self.ResLinkRefBtn.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.ResLinkRefBtn.setObjectName("ResLinkRefBtn")
    ...
    def retranslateUi(self, Form):
        ...
        self.UpdateBtn.setText(_translate("Form", "项目更新"))
        self.label_5.setText(_translate("Form", "SVN "))
        self.ResLink.setText(_translate("Form", "DEVDEVDEV"))
        self.ResLinkRefBtn.setText(_translate("Form", "刷新"))
